...
public class ShopContent implements Serializable {
	...
	private int shopContentId;
	/** 
	 * 获取商城内容编号
	 * @return 商城内容编号
	 */
	public int getShopContentId()
	{
		return shopContentId;
	}
	 ...
	 * @param 商城内容编号
	 */
	public void setShopContentId(int value)
	{
		shopContentId = value;
	}
	

	private wh.shop.model.ShopCategory shopCategory;
	/**
	 * 获取商城分类
	 * @return 商城分类
	 */
	public wh.shop.model.ShopCategory getShopCategory(){
		return this.shopCategory;
	}
	
	/**
	 * 设置商城分类
	 * @param shopCategory 商城分类
	 */
	public void setShopCategory(wh.shop.model.ShopCategory shopCategory){
	...
	public void setShopCategoryId(int value){
		if(shopCategory != null){
			shopCategory.setShopCategoryId(value);
		}else{
	...
	private int priceAnother;
	/** 
	 * 获取价格2
	 * @return 价格2
	 */
	public int getPriceAnother()
	{
		return priceAnother;
	}
	 ...
	 * @param 价格2
	 */
	public void setPriceAnother(int value)
	{
		priceAnother = value;
	}

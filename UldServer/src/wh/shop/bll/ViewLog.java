...
{
	private static ViewLog instance = new ViewLog();
	public static ViewLog getInstance() {
		return instance;
	}
	private static wh.shop.dal.ViewLog dal = new wh.shop.dal.ViewLog();
	 ...
	 * @return 浏览日志编号
	 */
	public int createUpdate(wh.shop.model.ViewLog model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.ViewLog model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.ViewLog
     */
	public wh.shop.model.ViewLog get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.ViewLog>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.ViewLog queryModel, RefObject<Integer> totalCount, 

...
{
	private static GoodsLabel instance = new GoodsLabel();
	public static GoodsLabel getInstance() {
		return instance;
	}
	private static wh.shop.dal.GoodsLabel dal = new wh.shop.dal.GoodsLabel();
	 ...
	 * @return 商品标签编号
	 */
	public int createUpdate(wh.shop.model.GoodsLabel model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.GoodsLabel model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.GoodsLabel
     */
	public wh.shop.model.GoodsLabel get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.GoodsLabel>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.GoodsLabel queryModel, RefObject<Integer> totalCount, 

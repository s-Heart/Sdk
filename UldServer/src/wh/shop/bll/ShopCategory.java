...
{
	private static ShopCategory instance = new ShopCategory();
	public static ShopCategory getInstance() {
		return instance;
	}
	private static wh.shop.dal.ShopCategory dal = new wh.shop.dal.ShopCategory();
	 ...
	 * @return 商城分类编号
	 */
	public int createUpdate(wh.shop.model.ShopCategory model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.ShopCategory model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.ShopCategory
     */
	public wh.shop.model.ShopCategory get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.ShopCategory>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.ShopCategory queryModel, RefObject<Integer> totalCount, 

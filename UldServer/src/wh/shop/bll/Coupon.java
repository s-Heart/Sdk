...
public class Coupon
{
	private static Coupon instance = new Coupon();
	public static Coupon getInstance() {
		return instance;
	}
	private static wh.shop.dal.Coupon dal = new wh.shop.dal.Coupon();
	 ...
	 * @return 优惠券编号
	 */
	public int createUpdate(wh.shop.model.Coupon model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.Coupon model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.Coupon
     */
	public wh.shop.model.Coupon get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.Coupon>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.Coupon queryModel, RefObject<Integer> totalCount, 

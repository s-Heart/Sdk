...
{
	private static ShopContent instance = new ShopContent();
	public static ShopContent getInstance() {
		return instance;
	}
	private static wh.shop.dal.ShopContent dal = new wh.shop.dal.ShopContent();
	 ...
	 * @return 商城内容编号
	 */
	public int createUpdate(wh.shop.model.ShopContent model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.ShopContent model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.ShopContent
     */
	public wh.shop.model.ShopContent get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.ShopContent>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.ShopContent queryModel, RefObject<Integer> totalCount, 

...
{
	private static Shipping instance = new Shipping();
	public static Shipping getInstance() {
		return instance;
	}
	private static wh.shop.dal.Shipping dal = new wh.shop.dal.Shipping();
	 ...
	 * @return 运费编号
	 */
	public int createUpdate(wh.shop.model.Shipping model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.Shipping model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.Shipping
     */
	public wh.shop.model.Shipping get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.Shipping>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.Shipping queryModel, RefObject<Integer> totalCount, 

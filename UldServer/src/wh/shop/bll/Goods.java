...
public class Goods
{
	...
	private static wh.shop.dal.Goods dal = new wh.shop.dal.Goods();
	 ...
	 * @return 商品编号
	 */
	public int createUpdate(wh.shop.model.Goods model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.Goods model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.Goods
     */
	public wh.shop.model.Goods get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.Goods>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.Goods queryModel, RefObject<Integer> totalCount, 

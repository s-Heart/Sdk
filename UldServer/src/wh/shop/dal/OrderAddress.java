...
public class OrderAddress
{
	 ...
	 * @return 商品订单地址编号
	 */
	public int createUpdate(wh.shop.model.OrderAddress model) throws Exception{
		Map<String, Object> inParameters = new HashMap<String, Object>();
		inParameters.put("OrderAddressId", model.getOrderAddressId());
		...
		inParameters.put("Ring", model.getRing());
		inParameters.put("Street", model.getStreet());
		...
		inParameters.put("DefaultType", model.getDefaultType());
		...
		int retValue = SQLHelper.runProcedureNonQuery(Config.CONNECTION_STRING_ULD,
			"{? = call WH_Shop_OrderAddress_CreateUpdate(" + sbBuilder.toString() + ")}", inParameters, outParameters);		
	 ...
	 * @return 商品订单地址
     */
	public wh.shop.model.OrderAddress get(int id) throws Exception{
		wh.shop.model.OrderAddress model = null;
		Map<String, Object> inParameters = new HashMap<String, Object>();
		inParameters.put("OrderAddressId", id);
		...
		String errMsg = "";
		try {
			rs = SQLHelper.runProcedure(Config.CONNECTION_STRING_ULD, "{call WH_Shop_OrderAddress_Get(?,?,?)}", inParameters, outParameters);
			if (rs != null) {
				rs.next();
				model = getModel(rs);
	...
	public List<wh.shop.model.OrderAddress> getList(wh.shop.model.OrderAddress queryModel, RefObject<Integer> totalCount, 
		...
		inParameters.put("OrderAddressId", queryModel.getOrderAddressId());
		...
		inParameters.put("Ring", queryModel.getRing());
		inParameters.put("Street", queryModel.getStreet());
		...
		inParameters.put("DefaultType", queryModel.getDefaultType());
		...
		String errMsg = "";
		try {
			rs = SQLHelper.runProcedure(Config.CONNECTION_STRING_ULD, "{call WH_Shop_OrderAddress_GetList(" + sbBuilder.toString() + ")}",
	...
	public void remove(int id) throws Exception{
		...
		try {
			SQLHelper.runProcedureNonQuery(Config.CONNECTION_STRING_ULD, "{call WH_Shop_OrderAddress_Remove(?,?,?)}", inParameters, outParameters);
		} catch (Exception e) {
			throw new Exception(e.getMessage(), e);
		}
	 ...
	 * @return
	 */
	protected static wh.shop.model.OrderAddress getModel(ResultSet rs) throws SQLException{
		wh.shop.model.OrderAddress m = null;
		if (rs != null)
        {
            m = new wh.shop.model.OrderAddress();
			try{
				m.setOrderAddressId(rs.getInt("OrderAddressId"));
				...
				m.setDefaultType(rs.getByte("DefaultType"));

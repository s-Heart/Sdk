...
public class Poster
{
	...
	private static wh.promotion.dal.Poster dal = new wh.promotion.dal.Poster();
	 ...
	 * @return 海报编号
	 */
	public int createUpdate(wh.promotion.model.Poster model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.promotion.model.Poster model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.promotion.model.Poster
     */
	public wh.promotion.model.Poster get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.promotion.model.Poster>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.promotion.model.Poster queryModel, RefObject<Integer> totalCount, 

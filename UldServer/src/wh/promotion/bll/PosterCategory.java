...
{
	private static PosterCategory instance = new PosterCategory();
	public static PosterCategory getInstance() {
		return instance;
	}
	private static wh.promotion.dal.PosterCategory dal = new wh.promotion.dal.PosterCategory();
	 ...
	 * @return 海报分类编号
	 */
	public int createUpdate(wh.promotion.model.PosterCategory model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.promotion.model.PosterCategory model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.promotion.model.PosterCategory
     */
	public wh.promotion.model.PosterCategory get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.promotion.model.PosterCategory>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.promotion.model.PosterCategory queryModel, RefObject<Integer> totalCount, 

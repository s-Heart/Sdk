...
/**
 * ChannelInterface业务逻辑层
 */
public class ChannelInterface
{
	private static ChannelInterface instance = new ChannelInterface();
	public static ChannelInterface getInstance() {
		return instance;
	}
	private static wh.promotion.dal.ChannelInterface dal = new wh.promotion.dal.ChannelInterface();
	 ...
	 * @return 渠道接口编号
	 */
	public int createUpdate(wh.promotion.model.ChannelInterface model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.promotion.model.ChannelInterface model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.promotion.model.ChannelInterface
     */
	public wh.promotion.model.ChannelInterface get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.promotion.model.ChannelInterface>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.promotion.model.ChannelInterface queryModel, RefObject<Integer> totalCount, 

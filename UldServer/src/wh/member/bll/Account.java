...
public class Account
{
	...
	private static wh.member.dal.Account dal = new wh.member.dal.Account();
	 ...
	 * @return 帐户编号
	 */
	public int createUpdate(wh.member.model.Account model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.member.model.Account model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.member.model.Account
     */
	public wh.member.model.Account get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.member.model.Account>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.member.model.Account queryModel, RefObject<Integer> totalCount, 

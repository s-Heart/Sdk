...
public class Refund
{
	private static Refund instance = new Refund();
	public static Refund getInstance() {
		return instance;
	}
	private static wh.member.dal.Refund dal = new wh.member.dal.Refund();
	 ...
	 * @return 退款编号
	 */
	public int createUpdate(wh.member.model.Refund model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.member.model.Refund model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.member.model.Refund
     */
	public wh.member.model.Refund get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.member.model.Refund>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.member.model.Refund queryModel, RefObject<Integer> totalCount, 

...
{
	private static UserPortrait instance = new UserPortrait();
	public static UserPortrait getInstance() {
		return instance;
	}
	private static wh.member.dal.UserPortrait dal = new wh.member.dal.UserPortrait();
	 ...
	 * @return 用户默认头像编号
	 */
	public int createUpdate(wh.member.model.UserPortrait model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.member.model.UserPortrait model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.member.model.UserPortrait
     */
	public wh.member.model.UserPortrait get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.member.model.UserPortrait>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.member.model.UserPortrait queryModel, RefObject<Integer> totalCount, 

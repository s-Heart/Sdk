...
{
	private static RebateDetail instance = new RebateDetail();
	public static RebateDetail getInstance() {
		return instance;
	}
	private static wh.member.dal.RebateDetail dal = new wh.member.dal.RebateDetail();
	 ...
	 * @return 返利详情编号
	 */
	public int createUpdate(wh.member.model.RebateDetail model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.member.model.RebateDetail model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.member.model.RebateDetail
     */
	public wh.member.model.RebateDetail get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.member.model.RebateDetail>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.member.model.RebateDetail queryModel, RefObject<Integer> totalCount, 

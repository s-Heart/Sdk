...
public class Order
{
	...
	private static wh.order.dal.Order dal = new wh.order.dal.Order();
	 ...
	 * @return 订单编号
	 */
	public int createUpdate(wh.order.model.Order model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.order.model.Order model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.order.model.Order
     */
	public wh.order.model.Order get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.order.model.Order>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.order.model.Order queryModel, RefObject<Integer> totalCount, 

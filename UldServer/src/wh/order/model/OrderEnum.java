...
public class OrderEnum {
	 ...
	 */
	public enum PayType {
		支付类型((byte)0),网上银行((byte)1),支付宝((byte)2),手机卡((byte)3),声讯((byte)4),点卡((byte)5),PayPal((byte)6),神州行((byte)7),联通((byte)8),电信((byte)9),钱包((byte)10),骏网一卡通支付((byte)65),盛大卡((byte)66),网易一卡通((byte)67),完美一卡通支付((byte)68),征途卡支付((byte)69),久游一卡通支付((byte)70),易宝E卡通支付((byte)71),纵游一卡通((byte)72),天下一卡通((byte)73),G币返还((byte)74),其他渠道((byte)75);

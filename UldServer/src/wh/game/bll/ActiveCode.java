...
{
	private static ActiveCode instance = new ActiveCode();
	public static ActiveCode getInstance() {
		return instance;
	}
	private static wh.game.dal.ActiveCode dal = new wh.game.dal.ActiveCode();
	 ...
	 * @return 激活码编号
	 */
	public int createUpdate(wh.game.model.ActiveCode model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.game.model.ActiveCode model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.game.model.ActiveCode
     */
	public wh.game.model.ActiveCode get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.game.model.ActiveCode>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.game.model.ActiveCode queryModel, RefObject<Integer> totalCount, 

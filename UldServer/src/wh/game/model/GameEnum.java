...
public class GameEnum {
	...
	public enum EnableType {
		启用状态((byte) 0), 开启_时间无关((byte) 1), 即将开启_时间相关((byte) 2), 停止_维护((byte) 4), 内测_需要激活码且时间相关(
				(byte) 8);
	...
	/**
	 * 游戏币类型：0、游戏币类型；1、元宝；2、金子；3、仙币；4、点卷；5、金币；6、五彩石；7、金锭
	 */
	public enum GameMoneyType {
		游戏币类型((byte) 0), 元宝((byte) 1), 金子((byte) 2), 仙币((byte) 3), 点卷((byte) 4), 金币(
				(byte) 5), 五彩石((byte) 6), 金锭((byte) 7);

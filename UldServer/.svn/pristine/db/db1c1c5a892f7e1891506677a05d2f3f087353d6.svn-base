...
{
	private static OrderLog instance = new OrderLog();
	public static OrderLog getInstance() {
		return instance;
	}
	private static wh.order.dal.OrderLog dal = new wh.order.dal.OrderLog();
	 ...
	 * @return 订单日志编号
	 */
	public int createUpdate(wh.order.model.OrderLog model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.order.model.OrderLog model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.order.model.OrderLog
     */
	public wh.order.model.OrderLog get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.order.model.OrderLog>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.order.model.OrderLog queryModel, RefObject<Integer> totalCount, 

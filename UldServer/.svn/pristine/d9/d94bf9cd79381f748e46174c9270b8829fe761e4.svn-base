...
public class StatisticAnalysis
{
	...
	private static wh.promotion.dal.StatisticAnalysis dal = new wh.promotion.dal.StatisticAnalysis();
	 ...
	 * @return 统计分析编号
	 */
	public int createUpdate(wh.promotion.model.StatisticAnalysis model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.promotion.model.StatisticAnalysis model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.promotion.model.StatisticAnalysis
     */
	public wh.promotion.model.StatisticAnalysis get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.promotion.model.StatisticAnalysis>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.promotion.model.StatisticAnalysis queryModel, RefObject<Integer> totalCount, 

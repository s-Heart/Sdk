...
{
	private static GoodsOrderLog instance = new GoodsOrderLog();
	public static GoodsOrderLog getInstance() {
		return instance;
	}
	private static wh.shop.dal.GoodsOrderLog dal = new wh.shop.dal.GoodsOrderLog();
	 ...
	 * @return 商品订单日志编号
	 */
	public int createUpdate(wh.shop.model.GoodsOrderLog model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.GoodsOrderLog model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.GoodsOrderLog
     */
	public wh.shop.model.GoodsOrderLog get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.GoodsOrderLog>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.GoodsOrderLog queryModel, RefObject<Integer> totalCount, 

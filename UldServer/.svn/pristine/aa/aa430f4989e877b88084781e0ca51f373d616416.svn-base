...
public class UserJiYou {

	public MessageReturn checkSid(String sid, int gameIdp, int serverIdp, int channelIdp, int channelSubIdp, int mobiledeviceIdp, int statisticAnalysisIdp) {
		...
		String checkSidUrl = "http://payunite.ulaoda.com/JiYouCheckSid.ashx?sid=" + sid;
	...
	public MessageReturn createOrder(wh.order.model.Order model, String channelUserId, int channelId, int channelSubId, String playerId) {
		...
		model.setServerId(ServerTools.getServerIdBySequenceNumber(model.getGameId(), model.getServerId(),"UserJiYou-createOrder"));

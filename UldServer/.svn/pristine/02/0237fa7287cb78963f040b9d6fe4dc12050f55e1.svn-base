...
{
	private static OrderChannel instance = new OrderChannel();
	public static OrderChannel getInstance() {
		return instance;
	}
	private static wh.order.dal.OrderChannel dal = new wh.order.dal.OrderChannel();
	 ...
	 * @return 订单渠道编号
	 */
	public int createUpdate(wh.order.model.OrderChannel model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.order.model.OrderChannel model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.order.model.OrderChannel
     */
	public wh.order.model.OrderChannel get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.order.model.OrderChannel>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.order.model.OrderChannel queryModel, RefObject<Integer> totalCount, 

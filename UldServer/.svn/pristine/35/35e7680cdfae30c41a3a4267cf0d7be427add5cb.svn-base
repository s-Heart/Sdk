...
public class City
{
	...
	private static wh.shop.dal.City dal = new wh.shop.dal.City();
	 ...
	 * @return 市编号
	 */
	public int createUpdate(wh.shop.model.City model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.City model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.City
     */
	public wh.shop.model.City get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.City>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.City queryModel, RefObject<Integer> totalCount, 

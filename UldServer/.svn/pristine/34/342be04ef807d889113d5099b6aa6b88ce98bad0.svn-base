...
public class Fortune
{
	...
	private static wh.member.dal.Fortune dal = new wh.member.dal.Fortune();
	 ...
	 * @return 幸运点编号
	 */
	public int createUpdate(wh.member.model.Fortune model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.member.model.Fortune model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.member.model.Fortune
     */
	public wh.member.model.Fortune get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
		wh.member.model.Fortune model = null;
		try {
			model = dal.get(id);
		} catch (Exception e) {
			myErr.setErr(-1, e.getMessage());
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.member.model.Fortune>
     */
	public List<wh.member.model.Fortune> getList(wh.member.model.Fortune queryModel, RefObject<Integer> totalCount, 
		boolean isAll, int pageIndex, int pageSize, String fldSort, int sortType, RefObject<MyErr> refMyErr){
		MyErr myErr = new MyErr();
		List<wh.member.model.Fortune> list = new ArrayList<wh.member.model.Fortune>();
		try {
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.member.model.Fortune queryModel, RefObject<Integer> totalCount, 

...
{
	private static GoodsOrder instance = new GoodsOrder();
	public static GoodsOrder getInstance() {
		return instance;
	}
	private static wh.shop.dal.GoodsOrder dal = new wh.shop.dal.GoodsOrder();
	 ...
	 * @return 商品订单编号
	 */
	public int createUpdate(wh.shop.model.GoodsOrder model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.GoodsOrder model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.GoodsOrder
     */
	public wh.shop.model.GoodsOrder get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.GoodsOrder>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.GoodsOrder queryModel, RefObject<Integer> totalCount, 

...
/**
 * GoodsOrderDetail业务逻辑层
 */
public class GoodsOrderDetail
{
	private static GoodsOrderDetail instance = new GoodsOrderDetail();
	public static GoodsOrderDetail getInstance() {
		return instance;
	}
	private static wh.shop.dal.GoodsOrderDetail dal = new wh.shop.dal.GoodsOrderDetail();
	 ...
	 * @return 商品订单详情编号
	 */
	public int createUpdate(wh.shop.model.GoodsOrderDetail model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.GoodsOrderDetail model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.GoodsOrderDetail
     */
	public wh.shop.model.GoodsOrderDetail get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.GoodsOrderDetail>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.GoodsOrderDetail queryModel, RefObject<Integer> totalCount, 

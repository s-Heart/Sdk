...
{
	private static RegTemplate instance = new RegTemplate();
	public static RegTemplate getInstance() {
		return instance;
	}
	private static wh.promotion.dal.RegTemplate dal = new wh.promotion.dal.RegTemplate();
	 ...
	 * @return 注册弹出层模板编号
	 */
	public int createUpdate(wh.promotion.model.RegTemplate model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.promotion.model.RegTemplate model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.promotion.model.RegTemplate
     */
	public wh.promotion.model.RegTemplate get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.promotion.model.RegTemplate>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.promotion.model.RegTemplate queryModel, RefObject<Integer> totalCount, 

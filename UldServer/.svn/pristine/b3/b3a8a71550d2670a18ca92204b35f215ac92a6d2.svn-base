...
{
	private static AccountDetail instance = new AccountDetail();
	public static AccountDetail getInstance() {
		return instance;
	}
	private static wh.member.dal.AccountDetail dal = new wh.member.dal.AccountDetail();
	 ...
	 * @return 帐户详情编号
	 */
	public int createUpdate(wh.member.model.AccountDetail model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.member.model.AccountDetail model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.member.model.AccountDetail
     */
	public wh.member.model.AccountDetail get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.member.model.AccountDetail>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.member.model.AccountDetail queryModel, RefObject<Integer> totalCount, 

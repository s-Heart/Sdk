...
public class GameInterface
{
	...
	private static wh.game.dal.GameInterface dal = new wh.game.dal.GameInterface();
	 ...
	 * @return 游戏接口编号
	 */
	public int createUpdate(wh.game.model.GameInterface model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.game.model.GameInterface model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.game.model.GameInterface
     */
	public wh.game.model.GameInterface get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.game.model.GameInterface>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.game.model.GameInterface queryModel, RefObject<Integer> totalCount, 

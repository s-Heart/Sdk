...
{
	private static District instance = new District();
	public static District getInstance() {
		return instance;
	}
	private static wh.shop.dal.District dal = new wh.shop.dal.District();
	 ...
	 * @return 区县编号
	 */
	public int createUpdate(wh.shop.model.District model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.District model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.District
     */
	public wh.shop.model.District get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.District>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.District queryModel, RefObject<Integer> totalCount, 

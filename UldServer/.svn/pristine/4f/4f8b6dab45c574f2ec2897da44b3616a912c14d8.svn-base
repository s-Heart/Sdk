...
public class Rebate
{
	private static Rebate instance = new Rebate();
	public static Rebate getInstance() {
		return instance;
	}
	private static wh.member.dal.Rebate dal = new wh.member.dal.Rebate();
	 ...
	 * @return 返利编号
	 */
	public int createUpdate(wh.member.model.Rebate model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.member.model.Rebate model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.member.model.Rebate
     */
	public wh.member.model.Rebate get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.member.model.Rebate>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.member.model.Rebate queryModel, RefObject<Integer> totalCount, 

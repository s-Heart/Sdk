...
public class ShoppingCart
{
	...
	private static wh.shop.dal.ShoppingCart dal = new wh.shop.dal.ShoppingCart();
	 ...
	 * @return 购物车编号
	 */
	public int createUpdate(wh.shop.model.ShoppingCart model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.ShoppingCart model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.ShoppingCart
     */
	public wh.shop.model.ShoppingCart get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.ShoppingCart>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.ShoppingCart queryModel, RefObject<Integer> totalCount, 

...
{
	private static UserActiveCode instance = new UserActiveCode();
	public static UserActiveCode getInstance() {
		return instance;
	}
	private static wh.server.dal.UserActiveCode dal = new wh.server.dal.UserActiveCode();
	 ...
	 * @return 领取过的激活码编号
	 */
	public int createUpdate(wh.server.model.UserActiveCode model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.server.model.UserActiveCode model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.server.model.UserActiveCode
     */
	public wh.server.model.UserActiveCode get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.server.model.UserActiveCode>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.server.model.UserActiveCode queryModel, RefObject<Integer> totalCount, 

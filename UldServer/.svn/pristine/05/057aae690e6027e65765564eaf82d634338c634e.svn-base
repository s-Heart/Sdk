...
{
	private static CouponDetail instance = new CouponDetail();
	public static CouponDetail getInstance() {
		return instance;
	}
	private static wh.shop.dal.CouponDetail dal = new wh.shop.dal.CouponDetail();
	 ...
	 * @return 优惠券详情编号
	 */
	public int createUpdate(wh.shop.model.CouponDetail model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.CouponDetail model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.CouponDetail
     */
	public wh.shop.model.CouponDetail get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.CouponDetail>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.CouponDetail queryModel, RefObject<Integer> totalCount, 

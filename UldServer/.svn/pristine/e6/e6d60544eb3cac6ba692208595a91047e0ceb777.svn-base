...
{
	private static GoodsPicture instance = new GoodsPicture();
	public static GoodsPicture getInstance() {
		return instance;
	}
	private static wh.shop.dal.GoodsPicture dal = new wh.shop.dal.GoodsPicture();
	 ...
	 * @return 商品图片编号
	 */
	public int createUpdate(wh.shop.model.GoodsPicture model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.GoodsPicture model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.GoodsPicture
     */
	public wh.shop.model.GoodsPicture get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.GoodsPicture>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.GoodsPicture queryModel, RefObject<Integer> totalCount, 

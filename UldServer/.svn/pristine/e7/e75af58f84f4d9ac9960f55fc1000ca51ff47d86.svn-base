...
public class Province
{
	...
	private static wh.shop.dal.Province dal = new wh.shop.dal.Province();
	 ...
	 * @return 省编号
	 */
	public int createUpdate(wh.shop.model.Province model, RefObject<MyErr> refMyErr) {
	 ...
	 * @return 消息对象
	 */
	public MessageReturn createUpdate(wh.shop.model.Province model) {
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return wh.shop.model.Province
     */
	public wh.shop.model.Province get(int id, RefObject<MyErr> refMyErr) {
		MyErr myErr = new MyErr();
	 ...
	 * @param refMyErr 
	 *        错误传递对象，传入时不可为空
	 * @return List<wh.shop.model.Province>
     */
	 ...
	 * @return 消息对象
     */
	public MessageReturn getList(wh.shop.model.Province queryModel, RefObject<Integer> totalCount, 

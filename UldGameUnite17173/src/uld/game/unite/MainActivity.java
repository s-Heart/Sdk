...
public class MainActivity extends Activity {
	...
	private Button btnLogout17173 = null;
	...
	private void findViews() {
		...
		btnLogout17173 = (Button) findViewById(R.id.btnLogout17173);
	}

	private void setListeners() {
		btnWelcome.setOnClickListener(new WelcomeListener());
		btnExit.setOnClickListener(new ExitListener());
		btnLogout17173.setOnClickListener(new Logout17173Listener());
	}
	...
	// 注销用户接口
	class Logout17173Listener implements OnClickListener {
	...
	private void LoginSDK() {
		...
		uld.sdk.unite.UldPlatform.getInstance().login(MainActivity.this, gameInfo, new LoginCallBackListener() {

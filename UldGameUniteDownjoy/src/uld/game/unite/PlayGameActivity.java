...
import org.xuehu.aj.ajdownjoy.R;
...
public class PlayGameActivity extends Activity {
	...
	private Button btnPlatform = null;
	...
	protected void onResume() {
		super.onResume();
		Downjoy.getInstance().resume(PlayGameActivity.this);
	}
	...
	private void setListeners() {
		...
		btnPlatform.setOnClickListener(new PlatformClickListener());
	}
	...
	// 用户中心调用接口
	class PlatformClickListener implements OnClickListener {
	...
	// 先调用退出接口，再退出游戏
	private void exit() {
		uld.sdk.unite.UldPlatform.getInstance().gotoFinish(PlayGameActivity.this);
		System.exit(0);
		finish();
	}

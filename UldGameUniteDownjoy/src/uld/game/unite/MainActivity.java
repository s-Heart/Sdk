...
public class MainActivity extends Activity {
	...
	private Button btnLogoutDownjoy = null;
	...
	private void findViews() {
		...
		btnLogoutDownjoy = (Button) findViewById(R.id.btnLogout17173);
	}

	private void setListeners() {
		btnWelcome.setOnClickListener(new WelcomeListener());
		btnExit.setOnClickListener(new ExitListener());
		btnLogoutDownjoy.setOnClickListener(new LogoutDownjoyListener());
	}
	...
	protected void onResume() {
	 	super.onResume();
	    Downjoy.getInstance().resume(MainActivity.this);
	}
